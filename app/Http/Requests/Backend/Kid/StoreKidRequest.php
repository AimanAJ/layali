...
namespace App\Http\Requests\Backend\Kid;
...
class StoreKidRequest extends FormRequest
{
    ...
    public function messages()
    {
        return[
            ...
            'playlist_id.integer' => 'Playlist must be an integer',
            'playlist_id.required' => 'Playlist is required',  
            'status.integer' => 'Status must be an integer',
            'status.required' => 'Status is required',  
            'duration.required' => 'Kids Program Duration is required',
            'url.required' => 'Kids Program URL is required',
            'url.url' => 'Kids Program URL is not valid',
        ];
    }
}
