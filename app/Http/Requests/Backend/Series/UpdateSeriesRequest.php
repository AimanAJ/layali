...
namespace App\Http\Requests\Backend\Series;
...
class UpdateSeriesRequest extends FormRequest
{
    ...
    public function messages()
    {
        return[
            ...
            'duration.required' => 'Series Duration is required',
            'url.required' => 'Series URL is required',
            'url.url' => 'Series URL is not valid',
        ];
    }
}
