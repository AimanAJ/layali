    ...
    public function update($id, UpdateAboutFormRequest $request, Route $route)
    {
        try {
            ...
            if ($about) {
                ...
                $update_data = [
                    'about_us_title_ar' => $request->about_us_title_ar,
                    'about_us_title_en' => $request->about_us_title_en,
                    'about_us_description_ar' => $request->about_us_description_ar,
                    'about_us_description_en' => $request->about_us_description_en,
                    'about_us_description_sub_ar' => $request->about_us_description_sub_ar,
                    'about_us_description_sub_en' => $request->about_us_description_sub_en
                ];

                // Upload Image :
                if (isset($request->about_us_image)) {
                    $file_name = $this->saveFile($request->about_us_image, 'storage/about_us_images/');
                    $update_data['about_us_image'] = $file_name;
                }
