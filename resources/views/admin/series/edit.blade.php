                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.series-index') }}">
                                    <i class="fas fa-users-cog"></i> All Series
                                </a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form id="createForm" action="{{ route('super_admin.series-update', isset($series->id) ? $series->id : -1) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-row">
                                                {{-- Series Title EN --}}
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Series Title EN: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('title_en')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="title_en"
                                                            ...
                                                            value="{!! isset($series->title_en) ? $series->title_en : null !!}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Series Title AR: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('title_ar')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="title_ar"
                                                            ...
                                                            value="{!! isset($series->title_ar) ? $series->title_ar : null !!}">
                                                    </div>
                                                </div>
                                                   {{-- Series URL --}}
                                                   <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Series URL: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('url')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="url"
                                                            ...
                                                            value="{!! isset($series->url) ? $series->url : null !!}">
                                                    </div>
                                                </div>
                                                {{-- Description EN --}}
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea style="width: 90% !important" name="description_en" maxlength="1600" class="form-control ckeditor" rows="20">
                                                            {!! isset($series->description_en) ? $series->description_en : null !!}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                {{-- Description AR --}}
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea style="width: 90% !important" name="description_ar" maxlength="1600" class="form-control ckeditor" rows="20">
                                                            {!! isset($series->description_ar) ? $series->description_ar : null !!}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                {{--  Image --}}
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    @if (isset($series->image) && $series->getRawOriginal('image') && file_exists($series->getRawOriginal('image')))
                                                ...
                                                <div class="col-md-6 mb-3">
                                                            ...
                                                            @if (isset($public_playlists) && $public_playlists->count() > 0)
                                                                @foreach ($public_playlists as $public_playlist)
                                                                    <option value="{{ $public_playlist->id }}"
                                                                        @if ($series->playlist_id != null) @if ($series->playlist_id == $public_playlist->id) selected @endif
                                                                    @else
                                                 ...
                                                 <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Series Duration: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('duration')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="duration"
                                                            ...
                                                            value="{!! isset($series->duration) ? $series->duration : null !!}">
                                                    </div>
                                                </div>  
                                                {{-- Status --}}
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select name="status" class="custom-select my-1 mr-sm-2 @error('status') is-invalid @enderror" id="inlineFormCustomSelectPref">
                                                            ...
                                                            <option value="1" @if (isset($series->status) && $series->status == 'Active') selected @endif>Active</option>
                                                            <option value="2" @if (isset($series->status) && $series->status == 'Inactive') selected @endif>Inactive</option>
                                                        </select>
                                                    </div>
                                                </div>
