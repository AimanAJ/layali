                    ...
                    <table id="hoverable-data-table" class="table table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center">  Name AR </th>
                        ...
                        <tbody>
                            @if (isset($categories) && $categories->count() > 0)
                                @foreach ($categories as $category)
                                    <tr>
                                        <td style="text-align: center">{!! isset($category->name_en) ? $category->name_en : "<span style='color:blue;'>----------</span>" !!} </td>
                                        <td style="text-align: center">{!! isset($category->name_ar) ? $category->name_ar : "<span style='color:blue;'>----------</span>" !!} </td>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{ route('super_admin.categories-softDelete', [isset($category->id) ? $category->id : '----------']) }}"
