                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Category Name EN: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('name_en')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name_en"
                                                            ...
                                                            value="{!! isset($categories->name_en) ? $categories->name_en : null !!}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Category Name AR: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('name_ar')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name_ar"
                                                            ...
                                                            value="{!! isset($categories->name_ar) ? $categories->name_ar : null !!}">
                                                    </div>
                                                </div>
