                                ...
                                <div class="media-body">
                                    ...
                                    <table id="hoverable-data-table" class="table table-hover table-striped">
                                        <thead>
                                            {{-- Category Name --}}
                                            <tr>
                                                <th>Category Name EN : <span style="color:blue;">{{ isset($categories->name_en) ? $categories->name_en : '------' }}</span></th>
                                                <th>Category Name AR : <span style="color:blue;">{{ isset($categories->name_ar) ? $categories->name_ar : '------' }}</span></th>
                                            </tr>
                                            ...
                                            {{-- Status --}}
                                            <tr>
                                                <th>Status: <span style="color:blue;">{!! isset($categories->status) ? $categories->status : '------' !!}</span></th>
                                            ...
                                            {{-- Addition Time/Date --}}
                                            <tr>
                                                <th><i class="mdi mdi-clock-outline mdi-spin"></i> Addition Time : <span style="color:blue;">{!! (isset($categories->created_at) ?  date('h:i A', strtotime($categories->created_at)) : '<span style="color:blue;">----------</span>') !!}</span></th>
                                                <th><i class="mdi mdi-clock-outline mdi-spin"></i> Addition Date : <span style="color:blue;">{!! (isset($categories->created_at) ?  date('Y / F (m) / d', strtotime($categories->created_at)) : '<span style="color:blue;">----------</span>') !!}</span></th>
                                            </tr>
                                            <tr>
