                ...
                <ol class="breadcrumb p-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('super_admin.movies-index') }}">
                            <span class="fa fa-th"></span> Movies
                        </a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page"> Add New Movie </li>
                </ol>
            </nav>
            </div>
            <<div class="content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    {{-- Form Section --}}
                                    <div class="card-body">
                                        <form id="createForm" action="{{ route('super_admin.movies-store') }}"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Movie Title EN: <strong class="text-danger"> *
                                                            @error('title_en')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Movie Title AR: <strong class="text-danger"> *
                                                            @error('title_ar')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Movie URL: <strong class="text-danger"> *
                                                            @error('url')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                       ...
                                                       <div class="col-md-6 mb-3">
                                                        <label class="text-dark font-weight-medium mb-3"
                                                            for="validationServer01">Movie Image : <strong
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Movie Duration: <strong class="text-danger"> *
                                                            @error('duration')
                                                                -
                                                                {{ $message }}
                                                            @enderror
