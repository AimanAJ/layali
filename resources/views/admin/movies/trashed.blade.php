    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1><i class="mdi mdi-delete"></i> Archived Movies</h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.movies-index') }}">
                                    <i class="mdi  mdi-home"></i> All Movies
                                </a>
                            </li>
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <table id="hoverable-data-table" class="table table-hover table-striped">
                        <thead>
                            <tr>
                                <th style="text-align: center"> Movies Title EN </th>
                                <th style="text-align: center"> Movies Title AR </th>
                            ...
                            @if (isset($movies) && $movies->count() > 0)
                                @foreach ($movies as $index => $movie)
                                    <tr>
                                        ...
                                        <td style="text-align: center">{!! isset($movie->playlist->title_en) ?$movie->playlist->title_en: "<span style='color:red;'>Undefined</span>" !!} </td>                                        <td style="text-align: center">{!! isset($movie->status) ? $movie->status : "<span style='color:red;'>Undefined</span>" !!} </td>
                                        ...
                                        <td>
                                            <a href="{{ route('super_admin.movies-softDeleteRestore', [isset($movie->id) ? $movie->id : '----------']) }}"
