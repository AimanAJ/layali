                ...
                <ol class="breadcrumb p-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('super_admin.programs-index') }}">
                            <span class="fa fa-th"></span> All Programs
                        </a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page"> Add New Program </li>
                </ol>
            </nav>
            </div>
            <<div class="content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    {{-- Form Section --}}
                                    <div class="card-body">
                                        <form id="createForm" action="{{ route('super_admin.programs-store') }}"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Program Title EN: <strong class="text-danger"> *
                                                            @error('title_en')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="title_en"
                                                            ...
                                                            id="validationServer01" placeholder="Program Title EN"
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Program Title AR: <strong class="text-danger"> *
                                                            @error('title_ar')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Program URL: <strong class="text-danger"> *
                                                            @error('url')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                       ...
                                                       <div class="col-md-6 mb-3">
                                                        <label class="text-dark font-weight-medium mb-3"
                                                            for="validationServer01">Program Image : <strong
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Program Duration: <strong class="text-danger"> *
                                                            @error('duration')
                                                                -
                                                                {{ $message }}
                                                            @enderror
