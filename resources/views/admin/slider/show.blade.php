...
@section('content')
    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        <div>
            <h1><i class="mdi mdi-information"></i> Slide Information</h1>
                ...
                <ol class="breadcrumb p-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('super_admin.slider-index') }}">
                            <i class="mdi mdi-format-list-bulleted"></i> All Sliders
                        </a>
                    </li>
                                ...
                                <div class="media-body">
                                    ...
                                    <table id="hoverable-data-table" class="table table-hover table-striped">
                                        <thead>
                                            {{-- Category Name --}}
                                            <tr>
                                                <th> Name EN : <span style="color:blue;">{{ isset($slide->name_en) ? $slide->name_en : '------' }}</span></th>
                                                <th> Name AR : <span style="color:blue;">{{ isset($slide->name_ar) ? $slide->name_ar : '------' }}</span></th>
                                            </tr>
                                            ...
                                            {{-- Status --}}
                                            <tr>
                                                <th>Status: <span style="color:blue;">{!! isset($slide->status) ? $slide->status : '------' !!}</span></th>

                                            </tr>

                                            {{-- Addition Time/Date --}}
                                            <tr>
                                                <th><i class="mdi mdi-clock-outline mdi-spin"></i> Addition Time : <span style="color:blue;">{!! (isset($slide->created_at) ?  date('h:i A', strtotime($slide->created_at)) : '<span style="color:blue;">----------</span>') !!}</span></th>
                                                <th><i class="mdi mdi-clock-outline mdi-spin"></i> Addition Date : <span style="color:blue;">{!! (isset($slide->created_at) ?  date('Y / F (m) / d', strtotime($slide->created_at)) : '<span style="color:blue;">----------</span>') !!}</span></th>
                                            </tr>
                                            <tr>
                                                {{-- Category Image --}}
                                                <th>
                                                     Image: <br /> <span style="color:blue;">
                                                        @if (isset($slide->image) && $slide->getRawOriginal('image') && file_exists($slide->getRawOriginal('image')))
                                                            <img src="{{ asset($slide->image) }}" width="100" height="100" style="border-radius: 10px; border:solid 1px black;">
                                                        @else
