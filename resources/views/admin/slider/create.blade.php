    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                {{-- ============================================== --}}
                <div>
                    <h1><i class="mdi mdi-playlist-plus"></i> Add New Slide</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.slider-index') }}"> <i class="mdi mdi-account-group"></i> All Slides </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i class="mdi mdi-playlist-plus"></i> Add New Slide</li>
                        </ol>
                    </nav>
                </div>
                                        ...
                                        <form action="{{ route('super_admin.slider-store') }}" method="POST"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                 ...
                                                 {{-- Image Field --}}
                                                 <div class="col-md-6 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" for="validationServer01"> Image : <strong class="text-danger">* @error('image') {{ $message }} @enderror</strong></label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
