    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1><i class="fas fa-user-md"></i> All slides Archived</h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.slider-index') }}">
                                    <i class="fas fa-spell-check"></i> All slides
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i
                                class="mdi mdi-delete"></i> All slides Archived
                            </li>
                        </ol>
                    </nav>
                </div>
                                    ...
                                    @foreach ($slides as $index => $slide)
                                        <tr>
                                            ...
                                            <td>
                                                @if (isset($slide->status))
                                                    @if ($slide->status == 'Active')
                                                        <span style="color: green;">{{ isset($slide->status) ? $slide->status : "<span style='color:red;'>Undefined</span>" }}</span>
                                                    @else
                                                        <span style="color: red;">{{ isset($slide->status) ? $slide->status : "<span style='color:red;'>Undefined</span>" }}</span>
                                                    @endif
                                                @else
                                            ...
                                            <td style="text-align: center">
                                                <a href="{{ route('super_admin.slider-softDeleteRestore', $slide->id) }}" class="unarchive mb-1 btn btn-sm btn-success"><i class="mdi mdi-redo-variant"></i></a>
                                                {{-- <a href="{{ route('super_admin.slider-destroy', [$slide->id]) }}" title="Permanently Delete" class="confirm mb-1 btn btn-sm btn-danger"><i class="mdi mdi-delete"></i></a> --}}
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
