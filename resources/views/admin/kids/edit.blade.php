                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.kids-index') }}">
                                    <i class="fas fa-users-cog"></i> All Kids Programs
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Edit kid Program</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form id="createForm" action="{{ route('super_admin.kids-update', isset($kid->id) ? $kid->id : -1) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-row">
                                                {{-- kids Title EN --}}
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">kids Program Title EN: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('title_en')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="title_en"
                                                            ...
                                                            id="validationServer01" placeholder="Kids Program Title EN"
                                                            value="{!! isset($kid->title_en) ? $kid->title_en : null !!}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Kids Program Title AR: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('title_ar')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="title_ar"
                                                            ...
                                                            id="validationServer01" placeholder="Kids Program Title AR"
                                                            value="{!! isset($kid->title_ar) ? $kid->title_ar : null !!}">
                                                    </div>
                                                </div>
                                                   {{-- kid URL --}}
                                                   <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Kids Program URL: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('url')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="url"
                                                            ...
                                                            id="validationServer01" placeholder="Kids URL"
                                                            value="{!! isset($kid->url) ? $kid->url : null !!}">
                                                    </div>
                                                </div>
                                                {{-- Description EN --}}
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea style="width: 90% !important" name="description_en" maxlength="1600" class="form-control ckeditor" rows="20">
                                                            {!! isset($kid->description_en) ? $kid->description_en : null !!}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                {{-- Description AR --}}
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea style="width: 90% !important" name="description_ar" maxlength="1600" class="form-control ckeditor" rows="20">
                                                            {!! isset($kid->description_ar) ? $kid->description_ar : null !!}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                {{--  Image --}}
                                                <div class="col-md-6 mb-3">
                                                    <label  class="text-dark font-weight-medium mb-3" for="validationServer01">Kids Program Image<strong class="text-danger">
                                                        * @error('image')
                                                            {{ $message }}
                                                        @enderror
                                                    </strong></label>
                                                    ...
                                                    @if (isset($kid->image) && $kid->getRawOriginal('image') && file_exists($kid->getRawOriginal('image')))
                                                ...
                                                <div class="col-md-6 mb-3">
                                                            ...
                                                            @if (isset($public_playlists) && $public_playlists->count() > 0)
                                                                @foreach ($public_playlists as $public_playlist)
                                                                    <option value="{{ $public_playlist->id }}"
                                                                        @if ($kid->playlist_id != null) @if ($kid->playlist_id == $public_playlist->id) selected @endif
                                                                    @else
                                                 ...
                                                 <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Kids Program Duration: <strong
                                                            class="text-danger">
                                                            *
                                                            @error('duration')
                                                                -
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="duration"
                                                            ...
                                                            id="validationServer01" placeholder="Kids Duration"
                                                            value="{!! isset($kid->duration) ? $kid->duration : null !!}">
                                                    </div>
                                                </div>  
                                                {{-- Status --}}
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select name="status" class="custom-select my-1 mr-sm-2 @error('status') is-invalid @enderror" id="inlineFormCustomSelectPref">
                                                            ...
                                                            <option value="1" @if (isset($kid->status) && $kid->status == 'Active') selected @endif>Active</option>
                                                            <option value="2" @if (isset($kid->status) && $kid->status == 'Inactive') selected @endif>Inactive</option>
                                                        </select>
                                                    </div>
                                                </div>
