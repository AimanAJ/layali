    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1><i class="mdi mdi-delete"></i> Archived Kids Programs</h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.kids-index') }}">
                                    <i class="mdi  mdi-home"></i> All Kids Programs
                                </a>
                            </li>
                            ...
                            @if (isset($kids) && $kids->count() > 0)
                                @foreach ($kids as $index => $kid)
                                    <tr>
                                        ...
                                        <td style="text-align: center">{!! isset($kid->playlist->title_en) ?$kid->playlist->title_en: "<span style='color:red;'>Undefined</span>" !!} </td>                                        <td style="text-align: center">{!! isset($kid->status) ? $kid->status : "<span style='color:red;'>Undefined</span>" !!} </td>
                                        ...
                                        <td>
                                            <a href="{{ route('super_admin.kids-softDeleteRestore', [isset($kid->id) ? $kid->id : '----------']) }}"
