                ...
                <ol class="breadcrumb p-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('super_admin.kids-index') }}">
                            <span class="fa fa-th"></span> Kids Programs
                        </a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page"> Add New Kids Program </li>
                </ol>
            </nav>
            </div>
            <<div class="content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    {{-- Form Section --}}
                                    <div class="card-body">
                                        <form id="createForm" action="{{ route('super_admin.kids-store') }}"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Kids Program Title EN: <strong class="text-danger"> *
                                                            @error('title_en')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="title_en"
                                                            ...
                                                            id="validationServer01" placeholder="Kids Title EN"
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Kids Title AR: <strong class="text-danger"> *
                                                            @error('title_ar')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="title_ar"
                                                            ...
                                                            id="validationServer01" placeholder="Kids Title AR"
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Kids URL: <strong class="text-danger"> *
                                                            @error('url')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="url"
                                                            ...
                                                            id="validationServer01" placeholder="Kids Program URL"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                       ...
                                                       <div class="col-md-6 mb-3">
                                                        <label class="text-dark font-weight-medium mb-3"
                                                            for="validationServer01">Kids Program Image : <strong
                                                ...
                                                {{--kids Program Duration --}}
                                                <div class="col-md-6">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Kids Program Duration: <strong class="text-danger"> *
                                                            @error('duration')
                                                                -
                                                                {{ $message }}
                                                            @enderror
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="duration"
                                                            ...
                                                            id="validationServer01" placeholder="Kids Program Duration"
